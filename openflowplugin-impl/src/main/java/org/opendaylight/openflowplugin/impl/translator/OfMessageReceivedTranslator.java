...
public class OfMessageReceivedTranslator implements MessageTranslator<OfHeader, OfMessageReceived> {
	...
	@Override
	public OfMessageReceived translate(OfHeader input, DeviceInfo deviceInfo, Object connectionDistinguisher) {
		OfMessageReceivedBuilder builder = new OfMessageReceivedBuilder();
        NodeRef nodeRef = new NodeRef(deviceInfo.getNodeInstanceIdentifier());
        short ofVersion = deviceInfo.getVersion();
